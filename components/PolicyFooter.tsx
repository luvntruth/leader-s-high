    ...
    <footer className="border-t border-white/10 bg-slate-950/80 px-5 py-8 text-xs text-slate-500">
      <div className="mx-auto max-w-5xl space-y-5">
        <div className="flex flex-wrap gap-x-4 gap-y-2 font-semibold text-slate-300">
          ...
          <a href={`mailto:${BUSINESS_INFO.customerSupportEmail}`} className="hover:text-amber-400 transition-colors">고객센터</a>
        </div>
        ...
        <div className="grid gap-2 sm:grid-cols-2 lg:grid-cols-3">
          ...
          <p><span className="text-slate-400">고객센터</span> {BUSINESS_INFO.customerSupportEmail}</p>
