...
export const PLAN_SUMMARY = {
  free: {
    ...
    features: ['3개 시나리오 체험', '시나리오당 1회 시도', '5턴 시뮬레이션', '간략 피드백 리포트'],
  },
  pro: {
    badge: '가장 인기',
    title: '프로',
    ...
    features: ['무료 체험 3개 + 직접 고르는 20개 (총 23개)', '10턴 심화 시뮬레이션 (무료의 2배)', '시나리오당 최대 3회까지 도전 가능', '풀 리포트 무제한', '이전 기록 보관 및 비교', '실시간 즉시 코칭'],
  },
  ultra: {
    badge: '프리미엄',
    title: '울트라',
