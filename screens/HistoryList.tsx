        ...
        {loading ? (
          ...
          history.map((item) => (
            <div
              ...
              className="bg-surface-dark/40 border border-white/5 p-5 rounded-[2rem] flex items-center justify-between group active:scale-[0.98] transition-all hover:border-primary/30 cursor-pointer"
            >
              <div className="flex items-center gap-4">
                <div className="size-12 rounded-2xl flex items-center justify-center shrink-0 bg-accent-neon/20 text-accent-neon shadow-[0_0_15px_rgba(0,242,255,0.2)]">
