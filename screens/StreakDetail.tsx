  ...
  return (
    <div className="h-screen bg-navy-deep text-gray-900 flex flex-col font-display overflow-hidden">
      <header className="p-6 flex items-center justify-between z-10">
        <button onClick={() => navigate(-1)} className="size-10 flex items-center justify-center rounded-full bg-gray-100 border border-gray-200">
          <span className="material-symbols-outlined">close</span>
        </button>
        <h2 className="text-sm font-bold uppercase tracking-widest text-gray-400">Activity Report</h2>
      ...
      <main className="flex-1 overflow-y-auto px-6 pb-20 scroll-smooth hide-scrollbar">
        <div className="flex flex-col items-center mt-4 mb-10 animate-in fade-in zoom-in duration-500">
          ...
          <p className="text-gray-500 font-medium">연속 리더십 챌린지 달성 중!</p>
        </div>

        <div className="bg-navy-card p-6 rounded-[2.5rem] border border-gray-200 mb-6 shadow-card">
        ...
        <div className="grid grid-cols-2 gap-4 mb-6">
          <div className="bg-navy-card p-5 rounded-3xl border border-gray-200">
            <p className="text-[10px] font-bold text-gray-400 uppercase mb-1">최장 기록</p>
            <p className="text-2xl font-bold">12일</p>
          </div>
          <div className="bg-navy-card p-5 rounded-3xl border border-gray-200">
            <p className="text-[10px] font-bold text-gray-400 uppercase mb-1">총 학습 일수</p>
        ...
        <div className="mt-8">
           ...
           <p className="text-center text-[10px] text-gray-400 mt-4 uppercase tracking-widest">Keep the flame alive!</p>
        </div>
      </main>
    </div>
  );
