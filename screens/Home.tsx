...
const Home: React.FC = () => {
  ...
  return (
    <div className="flex flex-col min-h-screen pb-24 lg:pb-12 bg-transparent font-manrope text-gray-900">
      {/* Header */}
      <div className="sticky top-0 z-50 bg-white/80 backdrop-blur-md px-6 py-5 flex items-center justify-between border-b border-gray-200 lg:px-12">
        <div className="flex items-center gap-3">
          ...
          <h2 className="text-xl font-bold tracking-tight text-gray-900 lg:text-2xl">대시보드</h2>
        </div>
      ...
      <div className="lg:px-12 lg:py-12">
        ...
        <div className="px-6 py-12 lg:px-0 lg:py-0 lg:mb-16 relative overflow-hidden">
          ...
          <h1 className="text-2xl lg:text-4xl font-bold tracking-tight text-gray-900 leading-[1.7]">
            팀원 퇴사율 0% 도전, <br/>
            <span className="text-primary italic">게임</span>처럼 익히는 팀장 리더십 시뮬레이션
          </h1>
          <p className="text-gray-500 mt-6 text-sm lg:text-base font-medium leading-[1.7] max-w-[550px]">
        ...
        <div className="lg:grid lg:grid-cols-12 lg:gap-8 space-y-8 lg:space-y-0">
          ...
          <div className="px-6 lg:px-0 lg:col-span-4 grid grid-cols-2 lg:grid-cols-1 gap-4">
            <div 
              ...
              className="bg-navy-card border border-gray-200 p-8 rounded-[2.5rem] shadow-card relative overflow-hidden group cursor-pointer hover:border-primary/30 transition-all"
            >
              <p className="text-[10px] font-bold text-gray-400 uppercase tracking-widest mb-1">Total Missions</p>
            ...
            <div 
              ...
              className="bg-navy-card border border-gray-200 p-8 rounded-[2.5rem] shadow-card cursor-pointer hover:border-accent-amber/30 transition-all relative overflow-hidden"
            >
              <p className="text-[10px] font-bold text-gray-400 uppercase tracking-widest mb-1">Current Streak</p>
              <p className="text-4xl font-black text-accent-amber drop-shadow-[0_0_10px_rgba(255,184,0,0.3)]">5 <span className="text-xs text-gray-400 font-bold uppercase ml-1">Days</span></p>
          ...
          <div className="px-6 lg:px-0 lg:col-span-8 space-y-6">
            <div className="flex items-center justify-between mb-4">
              <h3 className="text-lg font-bold tracking-tight text-gray-900 uppercase tracking-widest px-2">오늘의 추천 훈련</h3>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 pb-6 lg:pb-0">
              {SCENARIOS.slice(0, 4).map(scenario => (
                <div 
                  ...
                  className="bg-navy-card border border-gray-200 rounded-[3rem] overflow-hidden p-8 shadow-card flex flex-col justify-between active:scale-95 transition-all cursor-pointer hover:border-primary/50 group"
                >
                  <div>
                    ...
                    <h4 className="text-xl font-bold mb-3 tracking-tight text-gray-900 group-hover:text-primary transition-colors">{scenario.title}</h4>
                    <p className="text-gray-400 text-xs mb-10 line-clamp-2 leading-relaxed font-medium">{scenario.description}</p>
                  </div>
                  <div className="flex items-center gap-4 mt-auto pt-6 border-t border-gray-200">
                    <div className="size-10 rounded-2xl bg-gray-100 border border-gray-200 overflow-hidden">
                       <img 
                        src={`https://ui-avatars.com/api/?name=${encodeURIComponent(scenario.memberName)}&background=3182F6&color=FFFFFF`} 
                        alt={scenario.memberName} 
                        className="size-full object-cover" 
                       />
                    </div>
                    <div className="text-[11px]">
                      <p className="font-bold text-gray-900">{scenario.memberName} 매니저</p>
                      <p className="text-gray-400 font-bold uppercase">{scenario.generation}</p>
                    </div>
            ...
            <button
              ...
              className="w-full bg-navy-card border border-gray-200 p-10 rounded-[3.5rem] flex items-center justify-between transition-all active:scale-[0.98] hover:bg-gray-100 group shadow-card relative overflow-hidden"
            >
              ...
              <div className="flex items-center gap-6 text-left relative z-10">
                ...
                <div>
                  ...
                  <p className="text-gray-400 text-[11px] font-black uppercase tracking-[0.3em] mt-2">Personalized AI AI Scenario Lab</p>
                </div>
              </div>
              <div className="size-12 bg-gray-100 rounded-full flex items-center justify-center group-hover:translate-x-2 transition-transform">
